...
document.getElementById('descargarPDF').addEventListener('click', function() {
    ...
    link.href = './assets/Maidana _Martin_Nicolas.pdf'; // Especifica la ruta del archivo PDF que deseas descargar
    link.download = 'martin-maidana.pdf'; // Puedes especificar un nombre de archivo diferente si lo deseas
  ...
  function enviarFormulario() {
    ...
    window.location.href = "https://martinmaidana.github.io/Porfolio-Proyecto-codo-a-codo/";
}
